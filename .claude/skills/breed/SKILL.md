...
|---|------|--------|-----------|-------------|
| 1 | ゲームバージョンは？ | バージョン | scarlet_violet(default), legendsza, Other(バージョン名を入力) | false |
...
**結果が空の場合**: 名前の確認を再度AskUserQuestionで依頼。リージョンフォームやメガシンカフォームの場合は「v1では通常フォームのみ対応しています」と案内。
